jobs = {
    ...
    {"Pénztáros","Los Santos boltjaiban szolgáld ki a vásálókat!", true, false, "Los Santos, Red County", "",true},
    {"Pizzakészítő","Szolgáld ki a vásárlókat.", true, false, "Los Santos", "",true},
    {"Etikus Hacker","Hackeld meg a megbízóidat.", true, false, "Los Santos", "",true},
