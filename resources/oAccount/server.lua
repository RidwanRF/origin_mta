        ...
        if numAffect > 0 then
            for k,v in pairs(result) do
                ...
                if v["serial"] == getPlayerSerial(player) or v["serial"] == "*" then
                    ...
                    codes[player] = code
                    name = v["username"]
                    callRemote("https://originalrp.eu/forgotpw/forgot.php?username="..tostring(name).."&usermail="..tostring(validations).."&code="..code.."&verification=6v@I528LFqde53X4SEFNXK*Yk@3xUw5", function() end)
