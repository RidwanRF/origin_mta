                                ...
                                if exports.oDashboard:isPlayerFactionTypeMember({4, 5}) then
                                    if exports.oDashboard:getOnlineFactionTypeMemberCount({1}) < 2 then
                                        ...
                                        if not getElementData(flexObj, "atm:robStart") then 
                                            ...
                                            triggerServerEvent("factionScripts > cctv > sendMessage", root, core:getServerPrefix("blue-light-2", "ATM Rablás", 2).."Elkezdtek rabolni egy ATM-et, itt: "..color..getZoneName(getElementPosition(localPlayer)).."#ffffff.")
                                        end
