...
availableItems = {
	...
	{name = "M4", weight = 4.3,  isWeapon = true, ammo = 45, stacking = false, category="bag"}, -- 28
	{name = "Katana", weight = 6,  isWeapon = true, stacking = false, category="bag"}, -- 29
	{name = "Desert Eagle", weight = 2.8,  isWeapon = true, ammo = 47, stacking = false, category="bag"}, -- 30
	...
	{name = "Colt-45", weight = 2.2,  isWeapon = true, ammo = 47, stacking = false, category="bag"}, -- 37
	{name = "Mesterlövész", weight = 8,  isWeapon = true, ammo = 49, stacking = false, category="bag"}, -- 38
	{name = "P90", weight = 4.2,  isWeapon = true, ammo = 48, stacking = false, category="bag"}, -- 39
	{name = "UZI", weight = 3.5,  isWeapon = true, ammo = 48, stacking = false, category="bag"}, -- 40
	{name = "Sokkoló", weight = 2.4,  isWeapon = true, stacking = false, category="bag"}, -- 41
	...
	--Egyéb
	{name = "ÜRES ITEM", weight = 1.5, description = "Ki tudja mikori és mit rejthet?", stacking = false, category="bag"}, -- 140
	...
	{name = "ÜRES ITEM", weight = 0, description = "Bankjegy", stacking = false, category="licens"}, -- 144
	{name = "ÜRES ITEM", weight = 0, description = "Bankjegy", stacking = false, category="licens"}, -- 145
