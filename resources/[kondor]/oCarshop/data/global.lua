      ...
      --  },
...

        {
            ...
            category_cars = {
                ...
                {"", 585, 90000, 50, 178, "", _, "Hátsó kerék", _, 5, 2015, 6000},
    ...
    [2] = { -- Faction carshop
        {
            ...
            category_cars = {
                ...
                {"", 598, 100000, false, 258, "", _, "Hátsó kerék", _, 5, 2014, 0, allowedFactions = {1}},
                ...
                -- Szerelő ID: 3
                {"", 525, 300000, false, 258, "", _, "Hátsó kerék", _, 5, 2010, 0, allowedFactions = {1, 3}},

                -- Sörmaffia ID: 55, Teenager Homeboys ID: 59, Ganton Gangsters ID: 56, Maxikói frakció ID: 61, LC MOB: 64
                {"", 400, 200000, false, 258, "", _, "Hátsó kerék", _, 5, 2010, 0, allowedFactions = {55, 56, 59, 64}},
                {"", 445, 200000, false, 258, "", _, "Hátsó kerék", _, 5, 2010, 0, allowedFactions = {55, 56, 59, 61, 64}},
                {"", 442, 700000, false, 258, "", _, "Hátsó kerék", _, 5, 2010, 0, allowedFactions = {55, 56, 59, 61, 64}},
                {"", 516, 400000, false, 258, "", _, "Hátsó kerék", _, 5, 2010, 0, allowedFactions = {61, 64}},
                {"", 426, 120000, false, 258, "", _, "Hátsó kerék", _, 5, 2010, 0, allowedFactions = {61, 64}},
                {"", 546, 550000, false, 258, "", _, "Hátsó kerék", _, 5, 2010, 0, allowedFactions = {61, 64}},
                {"", 404, 220000, false, 258, "", _, "Hátsó kerék", _, 5, 2010, 0, allowedFactions = {61, 64}},
            },
        },
    },
