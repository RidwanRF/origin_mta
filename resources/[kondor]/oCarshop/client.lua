				...
				if buySelect then
					if core:isInSlot(sx * 0.5+6, sy * 0.53 - sy * 0.1 / 2 + 6, sx * 0.1-12, sy * 0.04-16) then
						...
						if (getElementData(localPlayer, "char:vehSlot") > #playerVehicles) then
							...
							triggerServerEvent("buyCarshopVehicle", resourceRoot, vehicles[shopType][selectedVehicleCategory].category_cars[selectedVehicle][2], vehicleColor, localPlayer, 0, vehicles[shopType][selectedVehicleCategory].category_cars[selectedVehicle][12], shopType, city)
							showCarshop()
						else
							...
							if (getElementData(localPlayer, "char:vehSlot") > #playerVehicles) then
								if (vehicles[shopType][selectedVehicleCategory].category_cars[selectedVehicle][4]) then
									if tonumber(getVehicleCount(vehicles[shopType][selectedVehicleCategory].category_cars[selectedVehicle][2])) <= vehicles[shopType][selectedVehicleCategory].category_cars[selectedVehicle][4] then 
										...
										local x, y, z = getElementPosition(localPlayer)
										local city = getZoneName(x, y, z, true)
										triggerServerEvent("buyCarshopVehicle", resourceRoot, vehicles[shopType][selectedVehicleCategory].category_cars[selectedVehicle][2], vehicleColor, localPlayer, price[1], 0, shopType, city)
										showCarshop()
									else
