...
players = {
    {true, 1, 11, "Carlos", 5, 63, 8},
    {false, 3, 4, "DrGates", 5, 6, 50},
    {true, 4, 0, "Daniel S Johnson", 5, 13, 36},
    {true, 7, 0, "Pablo Salamanca", 29, 21, 50},
    {true, 8, 7, "Costa", 5, 6, 2},
    {true, 9, 2, "Vegas", 2, 9, 15},
    {true, 10, 1, "Rosenstein Yael", 2, 3, 21},
    {true, 13, 0, "Jose Antonio", 2, 10, 40},
    {true, 14, 10, "Paul", 2, 6, 2},
    {true, 16, 0, "Seo Yoon", 2, 10, 100},
}
...
function renderScore()
    ...
    --dxDrawImage(x + sx*0.2145, y + 2/myY*sy, 22/myY*sy, 22/myY*sy, "files/logo.png", 0, 0, 0, tocolor(220, 220, 220, 255*logo_a))

    --dxDrawImage(x + 4/myX*sx, y + 2/myY*sy, 20/myX*sx, 20/myX*sx, "files/people.png", 0, 0, 0, tocolor(255, 255, 255, 240*a))
    --dxDrawImage(x + 45/myX*sx, y + 2/myY*sy, 20/myX*sx, 20/myX*sx, "files/admins.png", 0, 0, 0, tocolor(255, 255, 255, 240*a))
    --dxDrawText(color..#players-admincount.." #dcdcdcJátékos | #bd1111"..admincount.." #dcdcdcAdminisztrátor", x-sx*0.004, y, x-sx*0.004+w, y+sy*0.035, tocolor(220,220,220,255*a), 0.9, fonts["condensed-10"], "right", "center", false, false, false, true)
    ...
    for i = 1, 10 do
        if players[i+pointer] then 
            ...
            if v[1] then 
                dxDrawText(v[2], x+sx*0.01, starty, x+sx*0.05, starty+sy*0.038, tocolor(220,220,220,255*a), 0.8, fontScript:getFont("p_m", 15/myX*sx), "center", "center")
                ...
                if v[3] > 0 then 
                    ...
                    dxDrawImage(x+4/myX*sx, starty+2/myY*sy, 27/myX*sx, 27/myY*sy, ":oAccount/avatars/"..v[5]..".png", 0, 0, 0, tocolor(255,255,255,255*a))
                end
                ...
                dxDrawText(v[6], x+sx*0.05+sx*0.12, starty, x+sx*0.05+sx*0.12+sx*0.04, starty+sy*0.038, tocolor(220, 220, 220, 255*a),  0.8, fontScript:getFont("p_m", 15/myX*sx), "center", "center")

                local playerping = v[7]
                ...
                dxDrawText(v[2], x+sx*0.01, starty, x+sx*0.05, starty+sy*0.035, tocolor(220,220,220, 100*a), 0.8/myX*sx, fonts["sf-light-10"], "center", "center")
    ...
    dxDrawText("103", x + 22/myX*sx + ((w - 4/myX*sx) * multiplier) - sx*0.015, starty + sy*0.042 - (sy*0.02 * a), x + 22/myX*sx + ((w - 4/myX*sx) * multiplier) - sx*0.015 + sx*0.015, starty + sy*0.042 - (sy*0.02 * a) + sy*0.028, tocolor(255, 255, 255, 255 * a),  0.8, fontScript:getFont("p_bo", 15/myX*sx), "center", "center")
