local tables={ 	-- define table positions here
  -- x,y,z, dimension, interior
	{1507.1948242188, -1715.4262695313, 14.046875, 0,0}, -- two tables at grove street
...
--				moveObject(v.object, 75, nx,ny,z)
				--print(v.movement[1])
				--if v.movement[1] > 0 or v.movement[2] > 0 then
					moveObject(v.object, 70, nx, ny, z, 30, 30, 30)
