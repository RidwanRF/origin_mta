local handlings = {
	...
	[558] =	{4200, 4998.3, 1, 0, 0.1, -0.8, 70, 0.8, 0.61, 0.58, 5, 227, 37, 29, 'awd', 'petrol', 31, 0.48, false, 60, 0.81, 0.8, 5, 0.35, -0.15, 0.5, 0, 0.25, 0, 0, 1, 0,},
	...
	[480] = {2400, 3200, 2.2, 0, 0.1, -0.2, 75, 0.7, 0.9, 0.5, 5, 200, 15, 10, 'awd', 'petrol', 11, 0.45, true, 30, 1.4, 0.14, 3, 0.28, -0.15, 0.5, 0.3, 0.25, 0.8, 35000, 40000800, 0, 1, 1, 19},
...
--DANISPACE
		...
		elseif model == 405 then
						...
						setVehicleHandling(veh, "numberOfGears", 5)
						setVehicleHandling(veh, "maxVelocity", 170)       
						setVehicleHandling(veh, "engineAcceleration", 36)
						...
						setVehicleHandling(veh, "animGroup", 0)
						setVehicleHandling(veh, "suspensionUpperLimit", 0.0) -- magasság
						setVehicleHandling(veh, "suspensionLowerLimit", -0.19)
		...
		elseif model == 604 then  --cadillac 
						...
						setVehicleHandling(veh, "suspensionUpperLimit", 0.23) -- magasság
						setVehicleHandling(veh, "suspensionLowerLimit", -0.13)
		...
		elseif model == 400 then --Range Rover
						setVehicleHandling(veh, "mass", 5300)
						setVehicleHandling(veh, "turnMass", 6600)
						setVehicleHandling(veh, "centerOfMass", { 0.1, 0.2, -0.13 } )
