...
addEventHandler("onResourceStart", getResourceRootElement(),
	function ()
		serverDatabase = dbConnect("mysql", "dbname=original;host=localhost;charset=utf8", "root", "", "multi_statements=1")
		logsDatabase = dbConnect("mysql", "dbname=orp_logs;host=127.0.0.1;charset=utf8", "originalrp", "asCIrniKWh*vRvA-", "multi_statements=1")
