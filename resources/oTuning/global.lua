...
tuning_modifiers = {
    ["engine-1"] = {{"engineAcceleration", 0.6}, {"maxVelocity", 9.5}, {"dragCoeff", -0.05}},
    ["engine-2"] = {{"engineAcceleration", 0.6*2}, {"maxVelocity", 9.5*2}, {"dragCoeff", -0.05*2}},
    ["engine-3"] = {{"engineAcceleration", 0.6*3}, {"maxVelocity", 9.5*3}, {"dragCoeff", -0.05*3}},
    ["engine-4"] = {{"engineAcceleration", 0.6*4}, {"maxVelocity", 9.5*4}, {"dragCoeff", -0.05*4}},
...
tunings = {
    ...
    {title = "Egyéb", icon = "logo", tunings = {
        ...
        {title = "Rendszámtábla stílus", icon = "plate", options = {
            {title = "Alap", icon = "plate", price = {1, 0}, upID = 0},
            {title = "1", icon = "plate", price = {1, 0}, upID = 1},
            {title = "2", icon = "plate", price = {1, 0}, upID = 2},
            {title = "3", icon = "plate", price = {1, 0}, upID = 3},
